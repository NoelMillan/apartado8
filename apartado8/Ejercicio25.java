...
public class Ejercicio25 {
  public static void main(String[] args) {
    ...
    System.out.println("");
    System.out.print("Introduzca el número para saber su posición: ");
    int numPos = entrada.nextInt();
    System.out.print("El número " + numPos + " se encuentra en la posición " + Funciones.posicionEnArray(num, numPos));
  }
}